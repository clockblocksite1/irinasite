  ...
  return (
    ...
    <div className="App">
      ...
      <div className='pro'>
        ...
        <div className='sot'>
          <div className='ren'>Привет! Меня зовут Ирина Иванова и я практикующий</div>
          <div className='hoert'>хоумстейджер</div>
          <div className='clen'>Я помогу изменить вашу недвижимость в лучшую сторону,</div>
          <div className='qac'>раскрою и подчеркну сильные стороны вашей квартиры, а</div>
          <div className='dfg'>также ликвидирую все недостатки!</div>
      ...
      <div className='pooc'>
        <div className='root'  style={{ textDecoration: 'underline' }}>Все</div>
        <div className='wsx'>Квартиры</div>
        <div className='wer'>Дома</div>
      </div>
      <div className='wero'>
        <div className='col'>
          <img src={comImg} alt='' className='cotew' style={{ borderRadius: '0 40px 40px 0' }} />
          <div className='line'></div>
          <img src={cimImg} alt='' className='drok' style={{ borderRadius: '40px 0px 0px 40px' }}/>
        </div>
        <div className='wrt'>
          <div className='log'>Кейс №1</div>
          <div className='hart'>#Квартира</div>
          <div className='btn' style={{ textDecoration: 'underline' }} onClick={()=>setModalOpen8(true)}>Подробнее</div>
        </div>
      </div>
      <div className='rtu'>
        <div className='col'>
        <img src={comwiImg} style={{ borderRadius: '0 40px 40px 0' }} alt='' className='cotew'/>
          <div className='line'></div>
          <img src={comweImg} style={{ borderRadius: '40px 0px 0px 40px' }} alt='' className='drok'/>
        </div>
        <div className='wrt'>
          <div className='log'>Кейс №2</div>
          <div  className='hart'>#Дом</div>
          <div className='btn' onClick={()=>setModalOpen9(true)} style={{ textDecoration: 'underline' }}>Подробнее</div>
        </div>
      </div>
      <div className='bagi'>
        <div className='col'>
          <img src={gcomImg} style={{ borderRadius: '0 40px 40px 0' }} alt='' className='cotew'/>
          <div className='line'></div>
          <img src={lcomImg}  style={{ borderRadius: '40px 0px 0px 40px' }} alt='' className='drok'/>
        </div>
        <div className='wrt'>
          <div className='log'>Кейс №3</div>
          <div className='hart'>#Квартира</div>
          <tr/>
          <div className='btn' onClick={()=>setModalOpen10(true)} style={{ textDecoration: 'underline' }}>Подробнее</div>
